...
export const packages = [
  ...
  },
  {
    id: 'koota',
    name: 'koota',
    description: 'An ECS-based state management library optimized for real-time apps, games, and XR experiences.',
  ...
  },
  {
    id: 'xr',
    name: 'react-three/xr',
    description: 'VR/AR support for react-three-fiber. Build cross-platform XR applications with React.',
